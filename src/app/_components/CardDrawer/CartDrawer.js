    ...
    <>
          ...
          {activeTab === "cart" && (
            <>
              <div className="bg-white flex-1 h-[200px] p-1 sm:p-4 md:p-5 rounded-2xl flex flex-col mb-1 overflow-hidden min-h-0">
                <h3 className="font-semibold text-[#18181B] mb-3 sm:mb-4 text-sm sm:text-base flex-shrink-0">
                  My cart
                </h3>
              ...
              <div className="bg-white rounded-2xl p-1 sm:p-4 md:p-5 flex-shrink-0">
                <div className=" border-gray-200 pt-1">
                  <p className="font-medium text-[#18181B] mb-1 text-xs sm:text-sm">
                    Payment info
                  </p>
      ...
      {showSuccessDialog && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[100]">
          <div className="w-166 h-109.75 p-6  flex flex-col items-center justify-between bg-white rounded-2xl">
            ...
            <div
              className="w-47 h-11 bg-[#F4F4F5] rounded-full py-2.5 px-10.5 hover:bg-[#ff5b5b] cursor-pointer"
              onClick={() => {
                clearCart();
